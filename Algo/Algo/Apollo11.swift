...
struct wrapper {
    ...
    func ultimateWrap() {
        ...
        var first1 = xyz[0] as? String
        var first2 = xyz[0] as! String
        ...
        var aValue = aDictionary["name"]
        print(aValue)
        
        var aName = (aValue ?? "user") as? String
        var welcomeMessage = "welcome " + (aName ?? "J")
    ...
    func getDateMonthYearTupleWay() -> (year: Int, month: Int, date: String) {
            let date: String = ""
            let month: Int = 13
            let year: Int = 2025
 ...
 //    private func getDateMonthYearArrayWay() -> [Any] {
        func getDateMonthYearArrayWay() -> [Any] {
            let date: String = ""
            let month: Int = 13
            let year: Int = 2025
...
//        fileprivate func unwrapWithSwitch(opVar: String?)-> String {
        func unwrapWithSwitch(opVar: String?)-> String {
            switch (opVar) {
            case let ("not nil"):
                return "\(opVar)"
            case (nil):
